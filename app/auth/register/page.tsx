...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<"customer" | "mechanic">(
    defaultRole as "customer" | "mechanic"
  );
          ...
          <CardContent className="p-6 md:p-8 text-center">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="p-3 md:p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <Mail className="h-6 w-6 md:h-8 md:w-8 text-blue-600 mx-auto mb-2" />
              ...
              {role === "mechanic" && (
                <div className="p-3 md:p-4 bg-orange-50 border border-orange-200 rounded-lg">
                  ...
                  <p className="text-xs text-orange-700">
                    Your mechanic profile will be reviewed by our team. You'll
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Join our community of electrical service providers and customers
          </p>
        </div>
                ...
                <div className="space-y-4 border-t pt-6">
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-800">
                      <strong>Note:</strong> Mechanic accounts require
                      verification. Please provide accurate information as our
                      team will review your credentials before approval.
                    </p>
                  </div>
